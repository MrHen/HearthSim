...
public class TestMinionPlacement {
	...
	public void testCanBeUsedOnOpponentHero() throws HSException {
		...
		HearthTreeNode ret = archmage.useOn(PlayerSide.WAITING_PLAYER, this.board.data_.getCharacter(PlayerSide.WAITING_PLAYER, 0), this.board, null, null);
		assertNull(ret);
	...
	public void testCanBeUsedOnOpponentMinion() throws HSException {
		...
		HearthTreeNode ret = archmage.useOn(PlayerSide.WAITING_PLAYER, this.board.data_.getCharacter(PlayerSide.WAITING_PLAYER, 1), this.board, null, null);
		assertNull(ret);
	...
	public void testCanBeUsedOnOwnHero() throws HSException {
		...
		HearthTreeNode ret = archmage.useOn(PlayerSide.CURRENT_PLAYER, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 0), this.board, null, null);
		...
		assertEquals(archmage, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 1));
		assertEquals(raptor, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 2));
		assertEquals(yeti, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 3));
	...
	public void testCanBeUsedOnOwnMinionMiddle() throws HSException {
		...
		HearthTreeNode ret = archmage.useOn(PlayerSide.CURRENT_PLAYER, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 1), this.board, null, null);
		assertEquals(board, ret);
		...
		assertEquals(PlayerSide.CURRENT_PLAYER.getPlayer(board).getNumMinions(), 3);
		assertEquals(raptor, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 1));
		assertEquals(archmage, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 2));
		assertEquals(yeti, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 3));
	...
	public void testCanBeUsedOnOwnMinionRight() throws HSException {
		...
		HearthTreeNode ret = archmage.useOn(PlayerSide.CURRENT_PLAYER, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 2), this.board, null, null);
		assertEquals(board, ret);
		...
		assertEquals(PlayerSide.CURRENT_PLAYER.getPlayer(board).getNumMinions(), 3);
		assertEquals(raptor, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 1));
		assertEquals(yeti, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 2));
		assertEquals(archmage, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 3));
	...
	public void testSpellDamageStacks() throws HSException {
		...
		HearthTreeNode ret = kobold.useOn(PlayerSide.CURRENT_PLAYER, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 1), this.board, null, null);
		assertEquals(board, ret);

		kobold = new KoboldGeomancer();
		board.data_.placeCardHandCurrentPlayer(kobold);

		ret = kobold.useOn(PlayerSide.CURRENT_PLAYER, this.board.data_.getCharacter(PlayerSide.CURRENT_PLAYER, 1), this.board, null, null);
		assertEquals(board, ret);
