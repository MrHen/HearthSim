...
public class TestArgentProtector {
	...
	public void test2() throws HSException {
		...
		assertEquals(board.getChildren().get(0).data_.getCurrentPlayer().getMinions().get(0).getDivineShield(), true);
		assertEquals(board.getChildren().get(0).data_.getCurrentPlayer().getMinions().get(1).getDivineShield(), false);
		assertEquals(board.getChildren().get(1).data_.getCurrentPlayer().getMinions().get(1).getDivineShield(), true);
		assertEquals(board.getChildren().get(1).data_.getCurrentPlayer().getMinions().get(0).getDivineShield(), false);
