...
import com.hearthsim.card.spellcard.concrete.Hex;
...
public class TestHex {
	...
	public void test2() throws HSException {
		...
		assertEquals(PlayerSide.WAITING_PLAYER.getPlayer(board).getMinions().get(0).getTotalAttack(), 0);
		assertEquals(PlayerSide.WAITING_PLAYER.getPlayer(board).getMinions().get(1).getTotalAttack(), 6);

		assertTrue(PlayerSide.WAITING_PLAYER.getPlayer(board).getMinions().get(0) instanceof Frog);
	}
	...
	public void test3() throws HSException {
		...
		assertTrue(PlayerSide.WAITING_PLAYER.getPlayer(board).getMinions().get(1) instanceof Frog);
	}
}
